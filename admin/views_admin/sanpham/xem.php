...
<div class="container-fluid" id="noidung">
      ...
      <div style="background-color: #e5e5e5; padding: 60px 50px 10px; color:gray;border-radius: 20px;min-height: 500px;">
       ...
       <div class="col-sm-7">
        <table border="1" cellpadding="5">
          ...
          <tr>
            <td><h4>Tên</h4></td>
            <td><h4> &emsp;<?= $data['tenSP'];   ?>  </h4></td>
          </tr>
          <tr>
            <td><h4>Đơn Giá </h4></td>
            <td><h4> &emsp;<?= $data['Dongia'];   ?>  </h4></td>
          </tr>
          <tr>
            <td><h4>Màu </h4></td>
          ...
          <tr>
            ...
            <td><h4> &emsp;<?= $data['ngaynhap'];   ?>  </h4></td>
          </tr>
          <tr>
            <td><h4>Mô Tả</h4></td>
